...
# 内置 DNS 列表
DEFAULT_DNS_SERVERS=("1.1.1.1" "8.8.8.8" "9.9.9.9" "208.67.222.222" "199.85.126.10" "1.1.1.2" "64.6.64.6" "94.140.14.140")

# 内置 域名 列表
DEFAULT_DOMAINS=("www.gstatic.com" "www.google.com" "www.youtube.com" "cp.cloudflare.com")
# ===========================================
...
show_menu() {
    ...
    while true; do
        ...
        echo "2. 仅使用脚本内置DNS (1.1.1.1,8.8.8.8,9.9.9.9,208.67.222.222,199.85.126.10,1.1.1.2,64.6.64.6,94.140.14.140)"
        echo "3. 自定义 DNS (手动输入)"
